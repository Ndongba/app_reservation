        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="../traitement/client.php">
                    ...
                    <div class="mb-3">
                        <label for="date_depart" class="form-label">Date de Dapard</label>
                        <input type="date" class="form-control" id="date_depart" name="date_depart" required>
                    </div>
                    <div class="mb-3">
                        <label for="heur_depart" class="form-label">Heur de Dapard</label>
                        <input type="Time" class="form-control" id="heur_depart" name="heur_depart" required>
                    </div>
